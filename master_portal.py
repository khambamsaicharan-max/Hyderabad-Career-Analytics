...
# --- 3. 5-YEAR FORECAST LOGIC (Moved Up) ---
...
# Chart 2: Future Forecast Line Chart
forecast_fig = px.line(x=years, y=forecast_salaries, 
                       title="5-Year Career Growth Projection (15% Annual Rise)",
...
<head>
    ...
    <style>
        ...
        .hero-card {{ border: 2px solid #38bdf8; padding: 40px; border-radius: 20px; background: #111827; display: inline-block; margin: 20px 0; box-shadow: 0 10px 30px rgba(56, 189, 248, 0.3); }}
        ...
        .stat-box {{ background: #1e293b; padding: 20px; border-radius: 15px; min-width: 200px; border-bottom: 4px solid #4ade80; text-align: left; }}
    ...
    <div class="container">
        ...
        <div class="chart-section">
            ...
            <div style="margin-top: 20px; color: #9ca3af; padding: 15px; background: #1e293b; border-radius: 10px;">
                💡 <b>Strategy:</b> Target reach ₹30 Lakhs in <b>{years_to_30L:.1f} years</b>.
            </div>
        </div>
    </div>
</body>
...
# NOW WE SAVE THE FILE (At the very end)
with open("index.html", "w", encoding="utf-8") as f:
    f.write(html_template)

print("✅ DAY 18 SUCCESS: Portal Rebuilt with Market Data AND Future Predictions!")